  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto mt-16 px-4 text-center">
        <h2 className="text-4xl font-bold mb-10 text-lime-500 animate-pulse">
          Discover Our Products
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {["Tyres", "Tubes", "Lubricants", "Accessories"].map(
            (product, index) => (
              <div
                key={index}
                className="bg-neutral-800 p-8 rounded-lg shadow-md transition-all duration-300 hover:bg-red-800 hover:shadow-xl transform hover:-translate-y-1"
              >
                <h3 className="text-2xl font-semibold mb-4">{product}</h3>
                <p className="text-gray-300">
                  Experience top-quality {product.toLowerCase()} designed for
                  optimal performance and durability. Our selection caters to
        ...
        <h2 className="text-4xl font-bold mt-20 mb-10 text-lime-500">
          Why Choose falcom?
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            >
              ...
              <p className="text-gray-300">
                We prioritize {reason.toLowerCase()} to ensure you have the best
                possible experience with every purchase and interaction.
              </p>
            </div>
          ))}
        </div>

        <h2 className="text-4xl font-bold mt-20 mb-6 text-lime-500 animate-pulse">
          Join Our Community
        </h2>
        <p className="text-lg mb-8 max-w-2xl mx-auto">
          Stay up-to-date with the latest in automotive trends, tips, and
          exclusive offers by joining our falcom community. Be part of a
          passionate group of automotive enthusiasts.
        </p>
        <Link to="/register">
      ...
      <footer className="bg-red-900 w-full mt-20 py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-300">
            &copy; 2024 falcom. All rights reserved.
          </p>
